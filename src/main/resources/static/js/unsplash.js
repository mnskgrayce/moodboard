...
function load_info(post) {
    ...
    var description_button = document.getElementById("show_description");
    ...
    description_button.addEventListener('click', function (e) {
        console.log("Description button clicked")
        var cont = document.getElementById("description-container");
